...
In this page, we show an example of a dashboard. It shows the data for COVID-19 trend in the United States.

Here's the JSON data for the example.
      ...
      "axes": {
        ...
        "y": {
          ...
          "dataColumns": [
            ...
            {"name": "deathIncrease", "color": "#82ca9d"}
          ]
        }
      }
    },
    {
      ...
      "axes": {
        ...
        "y": {
          ...
          "dataColumns": [
            {"name": "positiveIncrease", "color": "#8884d8"},
            {"name": "hospitalizedIncrease", "color": "#82ca9d"}
          ]
        }
      }
    },
    {
      ...
      "axes": {
        ...
        "y": {
          ...
          "dataColumns": [
            {"name": "positiveIncrease", "color": "#8884d8"},
            {"name": "negativeIncrease", "color": "#82ca9d"}
          ]
        }
      }
    }
